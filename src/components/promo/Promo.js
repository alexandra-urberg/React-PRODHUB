  ...
  return (
    <section className="promo" id="main">
      ...
      <MediaQuery maxWidth={999}>
        <h1 className="promo__title promo__center">
          СДЕЛАЕМ КАЧЕСТВЕННЫЙ ЗАПУСК
        </h1>
        <div className="border promo__margin">
      ...
      <MediaQuery minWidth={1000}>
        <div className="promo__img-container">
          ...
          <img
            src={insta_fade}
            alt="gold_icon"
            className="container__img-opacity_s"
            data-aos="fade-up"
            data-aos-delay="120"
      ...
      <MediaQuery maxWidth={999}>
        ...
        ></img>
        <img src={iPhone_mockup} alt="phone_hand" className="promo__main-img" />
        <img src={insta_gold} alt="blur_icon" className="promo__blur-img" />
      </MediaQuery>
    </section>
  );
}
